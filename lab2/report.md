...
2. **Цель работы**: Научиться работать с bash
3. **Задание**: 
...
|= .              |
+----[SHA256]-----+
tar -c listing.md -f listing_archive.tar.gz -z
...
happis@happis-Vivobook:~/Рабочий стол/MAI$ scp listing n_gavrilov@185.5.249.140:/home/n_gavrilov
listing_archive.zip   listing.md 
happis@happis-Vivobook:~/Рабочий стол/MAI$ scp listing_archive.zip n_gavrilov@185.5.249.140:/home/n_gavrilov
listing_archive 100% 8265   769.6KB/s   00:00    
happis@happis-Vivobook:~/Рабочий стол/MAI$ scp listing_archive.tar.gz n_gavrilov@185.5.249.140:/home/n_gavrilov
listing_archive 100% 8213   912.8KB/s   00:00    
happis@happis-Vivobook:~/Рабочий стол/MAI$ scp n_gavrilov@185.5.249.140:/home/n_gavrilov/my_archive/listing.md listing.md
listing.md      100%   36KB   2.9MB/s   00:00  
tar: Error is not recoverable: exiting now
n_gavrilov@vds2476450:~$ mkdir my_archive
n_gavrilov@vds2476450:~$ tar -x -z -f listing_archive.tar.gz -C my_archive
n_gavrilov@vds2476450:~$ cd my_archive/
n_gavrilov@vds2476450:~/my_archive$ ls
listing.md
```
7. **Замечания**: Было достаточно муторно тестить заданный набор команд.
8. **Выводы**: Мне понравилась эта работа тем, что она позволила мне научиться использовать команду ssh для удаленного доступа к серверу. Я узнал, как правильно настроить соединение между клиентом и сервером, какие ключи использовать для авторизации и аутентификации, как отправлять команды на сервер через SSH-соединение. Также я научился работать с файлами на сервере и выполнять различные команды для их изменения или удаления.
Не понравилась мне эта работа тем, что я долго не мог разобраться со многими вопросами, связанными с подключением к серверу и его работой. В целом, я считаю, что данная работа была полезной для меня. Я научился использовать команду ssh для удаленного доступа к серверу, работать с файлами на сервере и выполнять различные команды для их изменения или удаления.
